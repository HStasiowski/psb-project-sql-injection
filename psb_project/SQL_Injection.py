...
def main():
    ...
    st.write(
        ...
        "(--), sprawimy że pozostały kod zostanie oznaczony jako komentarz, oraz nie wykona się.")

    st.subheader("Ominięcie hasła")
    st.write(
        "Osoba atakująca próbująca uzyskać dostęp do naszej aplikacji, może chcieć ominąc hasło. Można to uzyskać "
        "wstrzykując odpowiedni kod do pola hasła. Zapytanie do bazy sprawdza czy podana nazwa użytkownika oraz "
    ...
    st.write(
        ...
        "drugiego waruneku (1=1 - jest zawsze prawdą). W tym przypadku mimo że weryfikacja hasła zwróci FAŁSZ, "
    ...
    st.write(
        "Po wykonaniu ćwiczeń, może się okazać że aplikcja nie będzie funkcjonować tak jak powinna (np. po usunięciu "
